...
const STATIC: Array<[string, string]> = [
  ...
  ['/pausenrechner/', 'src/pages/pausenrechner.astro'],
  ['/ruhezeit-checker/', 'src/pages/ruhezeit-checker.astro'],
  ['/nachtzuschlag-rechner/', 'src/pages/nachtzuschlag-rechner.astro'],
  ['/gleitzeitkonto/', 'src/pages/gleitzeitkonto.astro'],
  ['/tarifmodelle/', 'src/pages/tarifmodelle.astro'],
